  ...
  return (
    <div className="max-w-2xl space-y-4">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-xl font-bold text-zinc-900 dark:text-zinc-100">Add Member</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white dark:bg-zinc-900 dark:bg-zinc-900 rounded-md border border-zinc-200 dark:border-zinc-700 p-6 space-y-5">
        ...
        <div>
          ...
          <p className="text-xs text-zinc-400 mt-1">Determines which section they appear in on the Our People page</p>
        </div>
